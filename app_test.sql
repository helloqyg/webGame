...
CREATE TABLE `pic` (
  ...
  'path' varchar(255) not null COMMENT '相片路径',
  'type' varchar(1) not null   comment '所属分类',
  PRIMARY KEY (`id`)
...
CREATE TABLE `type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  'type' varchar(1) not null   comment '分类名称',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8;
...
INSERT INTO `wd_auth_group_access` VALUES ('328', '5');
INSERT INTO `wd_auth_group_access` VALUES ('329', '4');
...
INSERT INTO `wd_company` VALUES ('363', '12', '123', '/upload/20170216/58a53d285447d.jpg', '123', '1', '231', '2', 'qiaoyonggang', '12313456', '1038607463@qq.com', '123', '13718188679', '13213213', '乔永刚', '134564654', '1038607463@qq.com', '程序员', '13718188679', '14564564', '1', null, '123', '23');
...
-- ----------------------------
INSERT INTO `wd_member` VALUES ('1', 'admin', 'fdc5a4ac8a4b4cbc6da642daaa2600e9', 'srln', '1488329697', '121.23.83.51', '1', '0', '225', '1', '0', '0', null);
...
INSERT INTO `wd_member` VALUES ('328', 'caiwu123', 'b6f215af43e34e53ab600d510c7d0e9e', 'rbiv', '1488329778', '121.23.83.51', '5', '0', '2', '1', '0', '0', null);
INSERT INTO `wd_member` VALUES ('329', 'xiangmu123', '0e762da76dac45421bbf385897b7029a', 'jxrk', '1488329795', '121.23.83.51', '4', '0', '2', '1', '0', '0', null);
